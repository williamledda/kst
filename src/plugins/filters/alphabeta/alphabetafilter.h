...
class AlphaBetaFilterSource : public Kst::BasicPlugin {
  Q_OBJECT
  ...
  public:
    ...
    Kst::ScalarPtr alphaScalar() const;
    Kst::ScalarPtr betaScalar() const;
    Kst::ScalarPtr deltaScalar() const;
  ...
  protected:
    AlphaBetaFilterSource(Kst::ObjectStore *store);
    ~AlphaBetaFilterSource();
...
class AlphaBetaFilterPlugin : public QObject, public Kst::DataObjectPluginInterface {
    Q_OBJECT
    Q_INTERFACES(Kst::DataObjectPluginInterface)
    Q_PLUGIN_METADATA(IID "com.kst.DataObjectPluginInterface/2.0")
  public:
    virtual ~AlphaBetaFilterPlugin() {}
